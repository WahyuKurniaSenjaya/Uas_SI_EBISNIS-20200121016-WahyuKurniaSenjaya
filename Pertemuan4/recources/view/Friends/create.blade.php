...
<form action="/friends" method="POST">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" nama="no_tlp" id="exampleInputPassword1" value="{{ old('nama' }}">
    @error('no_tlp')
    <div class="alert alert-danger">{{ $message }}</div>
  @enderror
  </div>
  <div class="form-group">
    ...
    <input type="text" class="form-control" nama="alamat" id="exampleInputPassword1" value="{{ old('nama' }}"> 
    @error('alamat')
    <div class="alert alert-danger">{{ $message }}</div>
  @enderror
  </div>
